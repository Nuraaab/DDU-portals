...
?>
				...
				<div class="sidebar-section">
					...
					<div class="text-uppercase font-size-xs line-height-xs mt-1">Main</div>
					 <i class="icon-menu" title="Main"></i></li>
						...
						<li class="nav-item">
							<a href="?section=control" class="nav-link {{request()->routeIs('editUser')|| request()->routeIs('register')||request()->routeIs('user') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
								<span>Control Payment</span>

							</a>
						</li>
						<li class="nav-item">
							<a href="?section=schedule" class="nav-link {{request()->routeIs('editUser')|| request()->routeIs('register')||request()->routeIs('user') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
								<span>Schedule</span>
	...
	<?php
        $section = isset($_GET['section']) ? $_GET['section'] : 'home';
            $sections = array(
                'home' => '../../components/cdeOfficer/home.php',
                'control' => '../../components/cdeOfficer/controlPayment.php',
				'schedule' => '../../components/cdeOfficer/schedule.php',
				'change_password' => '../../components/cdeOfficer/changePassword.php',
            );
