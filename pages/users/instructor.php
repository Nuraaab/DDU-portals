...
?>
				...
				<div class="sidebar-section">
					...
					<div class="text-uppercase font-size-xs line-height-xs mt-1">Main</div>
					 <i class="icon-menu" title="Main"></i></li>
						...
						<li class="nav-item">
							<a href="?section=view" class="nav-link {{request()->routeIs('editUser')|| request()->routeIs('register')||request()->routeIs('user') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
						...
						<li class="nav-item">
							<a href="?section=add" class="nav-link {{request()->routeIs('agent.create')|| request()->routeIs('agent.edit')||request()->routeIs('agent.index') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
	...
	<?php
        $section = isset($_GET['section']) ? $_GET['section'] : 'home';
            $sections = array(
                'home' => '../../components/instructor/home.php',
                'view' => '../../components/instructor/uploadMaterials.php',
                'add' => '../../components/instructor/addStudent.php',
				'change_password' => '../../components/instructor/changePassword.php',
            );
