...
?>
				...
				<div class="sidebar-section">
					...
					<div class="text-uppercase font-size-xs line-height-xs mt-1">Main</div>
					 <i class="icon-menu" title="Main"></i></li>
						...
						<li class="nav-item">
							<a href="?section=generate" class="nav-link {{request()->routeIs('editUser')|| request()->routeIs('register')||request()->routeIs('user') ? 'active' : '' }}">
	...
	<?php
        $section = isset($_GET['section']) ? $_GET['section'] : 'home';
            $sections = array(
                'home' => '../../components/registrarOfficer/home.php',
                'generate' => '../../components/registrarOfficer/generateReport.php',
                'student' => '../../components/registrarOfficer/student.php',
				"change_password" => "../../components/registrarOfficer/changePassword.php",
            );
