...
?>
				...
				<div class="sidebar-section">
					...
					<div class="text-uppercase font-size-xs line-height-xs mt-1">Main</div>
					 <i class="icon-menu" title="Main"></i></li>
						...
						<li class="nav-item">
							<a href="?section=register" class="nav-link {{request()->routeIs('editUser')|| request()->routeIs('register')||request()->routeIs('user') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
						...
						<li class="nav-item">
							<a href="?section=assign" class="nav-link {{request()->routeIs('agent.create')|| request()->routeIs('agent.edit')||request()->routeIs('agent.index') ? 'active' : '' }}">
                             <i class="icon-eye"></i>
						...
						<li class="nav-item">
							<a href="?section=course" class="nav-link {{request()->routeIs('customer.create')|| request()->routeIs('customer.edit')||request()->routeIs('customer.index') ? 'active' : '' }}">
						...
						<li class="nav-item">
							<a href="?section=department" class="nav-link {{request()->routeIs('customer.create')|| request()->routeIs('customer.edit')||request()->routeIs('customer.index') ? 'active' : '' }}">
                            <i class="icon-download"></i>
	...
	<?php
        $section = isset($_GET['section']) ? $_GET['section'] : 'home';
            $sections = array(
                'home' => '../../components/academicdean/home.php',
                'register' => '../../components/academicdean/registerInstructor.php',
                'assign' => '../../components/academicdean/assignInstructor.php',
                'course' => '../../components/academicdean/course.php',
				'department' => '../../components/academicdean/department.php',
				'change_password' => '../../components/academicdean/changePassword.php',
            );
