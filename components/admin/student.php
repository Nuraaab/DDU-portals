...
if (isset($_POST['submit'])) {
    ...
    $check_username_sql = "SELECT * FROM users WHERE username = '$username' AND role ='Student' ";
...
<div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline mt-3">
  ...
  <div class="d-flex">
      <div class="breadcrumb">
           <a class="breadcrumb-item" data-toggle="modal" data-target="#myModaldescription"><i class="icon-user mr-2"></i>Add Student</a>
      </div>
                      ...
                      <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            ...
                            <div class="col-sm-12 form-group-floating mb-3">
                            <div class="position-relative mb-10">
                                <input type="text" class="form-control form-control-outline" placeholder="Placeholder" required name="student_id">
                      ...
                      <div class="col-12">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="col-sm-12 form-group-floating mb-3">
                            <div class="position-relative mb-10">
                                <input type="text" class="form-control form-control-outline" placeholder="Placeholder" required name="student_id" value = "'.$row['username'].' ">
                                <label class="label-floating">Enter Student ID</label>
                            </div>
                            </div>
